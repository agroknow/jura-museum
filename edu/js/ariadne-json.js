...
//--            //if languageBlocks has ONLY one value => not array
                ...
                if(arrayWithJSONS[0].expressions[0]!=undefined && arrayWithJSONS[0].expressions[0].items!=undefined && arrayWithJSONS[0].expressions[0].items[0]!=undefined && arrayWithJSONS[0].expressions[0].manifestations[0].items[0].url!==undefined)
                {
	                jQuery('#itemAccess').append('<a target="_blank" href="'+arrayWithJSONS[0].expressions[0].manifestations[0].items[0].url+'" class="access  secondary">Access to the resource</a>');
                }
